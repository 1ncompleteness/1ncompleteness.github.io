    ...
    <div className="relative w-full py-4 sm:py-6 md:py-8">
      ...
      {currentPage > 0 && (
        <button
          ...
          className="fixed left-2 sm:left-3 md:left-4 top-1/2 -translate-y-1/2 z-[60] p-2 sm:p-2.5 md:p-3 rounded-full bg-white/10 hover:bg-primary/50 transition-all group"
      ...
      {currentPage < totalPages - 1 && (
        <button
          onClick={() => scrollToPage(currentPage + 1)}
          className="fixed right-2 sm:right-3 md:right-4 top-1/2 -translate-y-1/2 z-[60] p-2 sm:p-2.5 md:p-3 rounded-full bg-white/10 hover:bg-primary/50 transition-all group"
